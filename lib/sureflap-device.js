...
module.exports = class SureflapDevice extends Homey.Device {
  ...
  async registerListeners() {
    this.registerCapabilityListener('sureflap_lock_mode', async state => {
      ...
      await this._setLockState(state);
    });
    ...
    this.lockModeSet.registerRunListener(async (args, state) => {
      if (Object.prototype.hasOwnProperty.call(args, 'lock_mode')) {
        ...
        await this._setLockState(args.lock_mode);
      }
    });
    ...
    this.lockModeIs.registerRunListener((args, state) => {
      ...
      return Object.prototype.hasOwnProperty.call(args, 'lock_mode') && args.lock_mode === this.getCapabilityValue('sureflap_lock_mode');
    });
  }
