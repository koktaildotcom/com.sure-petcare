  ...
  tags: [
    ...
    if (Object.prototype.hasOwnProperty.call(deviceData, 'household_id') !== false) {
      ...
      const context = syncData.filter(timeline => {
        return timeline.type === 21 && timeline.devices.find(device => {
      ...
      if (context.length > 0) {
        ...
        if (Object.prototype.hasOwnProperty.call(current, 'weights') !== false && current.weights.length > 0) {
          ...
          if (frames.length === 1) {
            ...
            await this.setDeviceCapabilityValue('weight.both', frames[0].current_weight);
            ...
            await this.setDeviceCapabilityValue('weight.left', frames[0].current_weight);
            await this.setDeviceCapabilityValue('weight.right', frames[1].current_weight);
          }
        }
